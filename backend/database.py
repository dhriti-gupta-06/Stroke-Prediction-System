...
class Patient(db.Model):
    ...
    predictions = db.relationship('PredictionHistory', backref='patient',
                                  lazy='dynamic', order_by='PredictionHistory.created_at')
...
class PredictionHistory(db.Model):
    ...
    confidence_score  = db.Column(db.String(20))   # e.g. "Low / Moderate / High / Critical"
    model_used        = db.Column(db.String(50), default='LightGBM')
    prediction_source = db.Column(db.String(20), default='single')  # single | batch
    created_at        = db.Column(db.DateTime, default=datetime.utcnow)
